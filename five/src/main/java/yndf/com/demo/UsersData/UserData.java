...
public class UserData {
    ...
    static {
        ...
        peoples.add(new Users(10001, "孙三", "技术开发部1",new Date("2011/02/01")));
        peoples.add(new Users(10002, "李四", "技术开发部2",new Date("2021/02/01")));
        peoples.add(new Users(10003, "周五", "技术开发部3",new Date("2031/02/01")));
    }
